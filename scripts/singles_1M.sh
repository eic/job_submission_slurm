...
sbatch --account=rrg-wdconinc --parsable --array=1-4  --time=24:00:00 submit.sh single EVGEN/SINGLE/pi+_50GeV_3to50deg.steer   250000
...
sbatch --account=rrg-wdconinc --parsable --array=1-20 --time=24:00:00 submit.sh single EVGEN/SINGLE/pi+_50GeV_45to135deg.steer    50000
...
sbatch --account=rrg-wdconinc --parsable --array=1-50 --time=24:00:00 submit.sh single EVGEN/SINGLE/e-_50GeV_45to135deg.steer    20000
...
sbatch --account=rrg-wdconinc --parsable --array=1-40 --time=24:00:00 submit.sh single EVGEN/SINGLE/gamma_50GeV_45to135deg.steer    25000
...
sbatch --account=rrg-wdconinc --parsable --array=1-20 --time=24:00:00 submit.sh single EVGEN/SINGLE/mu-_50GeV_45to135deg.steer    50000
...
sbatch --account=rrg-wdconinc --parsable --array=1-32 --time=24:00:00 submit.sh single EVGEN/SINGLE/e-_50GeV_130to177deg.steer    32150
